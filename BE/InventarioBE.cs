...
namespace BE
{
    ...
    public class DetInventarioBE
    {
        public int Id_DetalleInventario { get; set; }
        public int Id_Inventario { get; set; }
        public string Cod_Inventario { get; set; }
        ...
        public double Stock_Inicial { get; set; }
        public double Stock_Final { get; set; }
        public int Flg_Esnuevo { get; set; }
        public string Serie_Prod { get; set; }
    }
    public class TblInventarioBE
    {
